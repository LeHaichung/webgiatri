            ...
            <div class="container">
                        ...
                        <div class="collapse navbar-collapse" id="main-menu">
                            <ul class="navbar-nav">
                                <li class="nav-item"><a class="active nav-link px-3"
                                                        style="color: black;" href="Home">Trang chủ</a></li>
                ...
                <div class="row img mx-1 ">
                    ...
                    <div class="my-5 pr-4 col-md-10 col-sm-10 col-10 bg-white">
                        <h1 class="p-3 ">GIỚI THIỆU WINDCHASER.COM</h1>
                        <div class="p-3 content">
                            <p>Windchaser là một website tổng hợp về những thông tin liên
                                quan đến Giải trí với nhiều mảng giải trí khác nhau. Đến với
                                Winchaser bạn có thể có thêm thông tin về các mảng giải trí như
                                truyện tranh, game,.... Mỗi ngày nhiều tin tức về thông tin mới
                                nhất về mảng giải trí ,.Tại đây, Windchaser chia sẻ nhưng tin tức
                                hấp dẫn và gay cấn đến cho các bạn để các bạn có thể trải nghiệm
                                tốt nhất khi đến với chúng tôi . Ở đây Winchaser sẽ tổng , phân
                                loại, để nhóm các bài viết liên quan và hiển thị theo sở thích
                                đọc tin của các bạn.</p>
                            <p>Khi đến đây mọi người có thể tìm thấy những thông tin yêu
                                thích,nếu bạn đam vê anime hay hóng những tin tức drama hot hit
                                thì ở Windchaser sẽ cập nhật những tin tức nóng hổi để đưa đến
                                cho người đọc những trải nghiệp vui vẻ và bổ ích .Windchaser ra
                                đời để giúp cho độc giả giải đáp những thắc mắc xoay quanh đến
                                ngành giải trí của chúng ta, Windchaser sẻ như là món ăn tinh
                                thần mỗi ngày cho các bạn . Winchaser là câu trả lời cho những
                                vấn đề sau:</p>
                            <p>Tôi muốn biết những sự kiện hot nhất diễn ra trong ngày
                                hoặc trong thời gian vừa qua ? Tôi muốn theo dõi các thông tin
                                giải trí (game, điện ảnh, truyện tranh hay một bộ phim anime hót
                                hit mà bạn k nên bỏ lỡ) về một chủ đề mà tôi quan tâm (vd : Điện
                                ảnh Hàn Quốc, drama của showbit ...)</p>
                            <p>Tôi chỉ muốn xem những thông tin mà tôi thích (vd : giới
                                thiệu về tập truyện sắp ra mà bạn đang mong chờ hay là một ca
                                khúc chuẩn bị ra của ca sĩ bạn hâm mô và những tin tức đáng mong
                                chờ mà Winchaser đang và sẽ cập nhập...)</p>
                            <p>Sau khi bạn đọc giới thiệu về bên tin tức của Windchaser,
                                có phải bạn đang chờ đợi những tin tức gay cấn mà sắp tới
                                WIndchaser sẽ đem đến đúng không nào ^^. Vậy còn chờ gì nữa mà
                                không đến bên Windchaser để cảm nhận những trải nghiệm mới nhất
                                nào.</p>
                        </div>
                    </div>
                    <div class="col-md-1 col-sm-1 col-1"></div>
                        ...
                        <div class="container p-4">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-12 col-12 mb-4 mb-md-0">
                                    <h5 class="text-uppercase"
                                        style="color: #1A8C71; font-size: 13px">Liên hệ quảng cáo
                                    </h5>
                                    <ul class=" mb-2"
                                        ...
                                        <li class="mb-2"><a href="#!" class="text-black"
                                                            style="text-decoration: none;"> Liên hệgmail :
