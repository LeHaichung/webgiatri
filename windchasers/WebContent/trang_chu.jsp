      ...
      <div class="container">
        <div class="top">
          <div class="row mt-1 py-1 navbar navbar-expand-md">
            ...
            <a class="navbar col-md-2 col-sm-3 col-3"
              ><span class="ms-auto" style="color: black"
                ><i class="fas fa-user"></i> Đăng nhập</span
              ></a
            >
          </div>
          ...
          <nav class="mt-1 py-1 navbar navbar-dark navbar-expand-md">
            ...
            <div class="collapse navbar-collapse" id="main-menu">
              <ul class="navbar-nav">
                <li class="nav-item">
                  <a class="active nav-link px-3" style="color: black" href=""
                    >Trang chủ</a
                  >
                </li>
                <li class="nav-item">
                  <a class="nav-link px-4" style="color: black" href=""
                    >Điện ảnh - Truyền hình</a
                  >
                </li>
                <li class="nav-item">
                  <a class="nav-link px-4" style="color: black" href=""
                ...
                <li class="nav-item">
                  <a class="nav-link px-4" style="color: black" href="">Game</a>
                </li>
                <li class="nav-item">
                  <a class="nav-link px-4" style="color: black" href=""
                    >Truyện tranh</a
        ...
        <div class="header mt-3 row">
          <a
            ...
            class="col-md-7 col-sm-7 col-12 nav-link"
          >
            <img
              class="rounded img-fluid"
              width="1100"
              alt=""
              src="img/lynk-1594449930-width800height583.jpg"
            />
            <span style="font-size: 20px">
              Lynk Lee chia sẻ về kế hoạch lập gia đình, tiết lộ bí mật tình
              cảm</span
            >
          </a>
          <div class="col-md-5 col-sm-5 col-12">
            <div class="row">
              <a
                ...
                class="nav-link"
                ><img
                  class="rounded img-fluid col-md-12 col-sm-12 col-12"
                  alt=""
            ...
            <div class="row mt-1">
              <a
                ...
                class="col-md-6 col-sm-6 col-6 nav-link"
                ><img
                  class="rounded img-fluid"
                  alt=""
                ...
                />
                <span
                  >Anime Spy x Family tung ra trailer mới cùng những thông tin
                  ...</span
                >
              </a>
              <a
                ...
                />
                <span
                  >Cuộc sống của “ông bố quốc dân” Trung Anh sau khi về hưu
                </span>
              </a>
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-md-8 col-sm-8 col-12 left">
              ...
              <div class="row my-2">
                ...
                <div class="col-md-7 col-sm-5 col-7">
                  ...
                  >
                    <span class="p-0"
                      >Loạt drama chấn động showbiz Việt năm 2021...</span
                    >
                  </a>
                  <br />
                  <p class="genre p-1">Âm nhạc</p>
                  <p>
                    2021 thực sự là một năm đầy biến động đối với CĐM và showbiz
                    Việt. Từ ồn ào tình cảm...
                  </p>
                </div>
              </div>
              ...
              <div class="row my-2">
                ...
                <div class="col-md-7 col-sm-5 col-7">
                  ...
                  >
                    <span class="p-0"
                      >Tài tử 'Phương Thế Ngọc' Trần Tùng Dũng qua...</span
                    >
                  </a>
                  <br />
                  <p class="genre p-1">Điện ảnh-Truyền hình</p>
                  <p>
                    Ngày 17/12, trang Sina đưa tin nam diễn viên Trần Tùng Dũng
                    qua đời ở tuổi 80. Ông từng...
                  </p>
                </div>
              </div>
              <div class="row my-2">
                ...
                <div class="col-md-7 col-sm-5 col-7">
                  ...
                  >
                    <span class="p-0"
                      >Trúc Nhân, Lan Ngọc trong hậu trường MV tết...</span
                    >
                  </a>
                  <br />
                  <p class="genre p-1">Âm nhạc</p>
                  <p>
                    Trúc Nhân kết đôi với Ninh Dương Lan Ngọc, quay trở lại với
                    siêu phẩm nhạc Tết 2022 ...
                  </p>
                </div>
              </div>
              ...
              <div class="row my-2">
                ...
                <div class="col-md-7 col-sm-5 col-7">
                  ...
                  >
                    <span class="p-0"
                      >PUBG được phát hành miễn phí từ ngày 12/01 ...</span
                    >
                  </a>
                  <br />
                  <p class="genre p-1">Game</p>
                  <p>
                    Cách đây 4 năm, PlayerUnknown’s Battlegrounds (PUBG) đã có
                    mặt trên Steam...
                  </p>
                </div>
              </div>
              ...
              <div class="row my-2">
                ...
                <div class="col-md-7 col-sm-5 col-7">
                  ...
                  >
                    <span class="p-0"
                      >Tác giả Fujimoto hé lộ về tiến độ sáng tác của Chainsaw
                      Man ss2</span
                    >
                  </a>
                  <br />
                  <p class="genre p-1">Game</p>
                  <p>
                    Trong một buổi phỏng vấn gần đây thì tác giả Tatsuki
                    Fujimoto đã tiết lộ cho khán giả ...
                  </p>
                </div>
              </div>
              ...
              <div class="row my-2">
                ...
                <div class="col-md-7 col-sm-5 col-7">
                  ...
                  >
                    <span class="p-0"
                      >Anime Tales of Luminaria tiết lộ ngày phát hành thông qua
                      ...</span
                    >
                  </a>
                  <br />
                  ...
                  <p>
                    Những hình ảnh mới nhất của nam diễn viên điển trai Dương
              ...
              <div class="row my-2">
                ...
                <div class="col-md-7 col-sm-5 col-7">
                  ...
                  >
                    <span class="p-0"
                      >Giải trí TVB bị chỉ trích vì đối xử tệ bạc với 1.000 nhân
                      viên</span
                    >
                  </a>
                  <br />
                  <p class="genre p-1">Điện ảnh-Truyền hình</p>
                  <p>
                    Bữa tiệc mừng lễ khánh đài lần thứ 55 được TVB tổ chức cho
                    nhân viên bị chê hời hợt. Theo tin tức, lãnh đạo đài không
                    tham dự sự kiện....
                  </p>
                </div>
              </div>
              ...
              <div class="row my-2">
                <div class="col-md-5 col-sm-7 col-5">
                  <img
                    class="rounded img-fluid"
                    alt=""
                    src="img/mariahcareyeternally12yearsold_2_thumb.jpg"
                  />
                </div>
                ...
                <div class="col-md-7 col-sm-5 col-7">
                  ...
                  >
                    <span class="p-0"
                      >Hồi kí tiết lộ quá khứ âm u của diva Mariah Carey</span
                    >
                  </a>
                  <br />
                  <p class="genre p-1">Điện ảnh-Truyền hình</p>
                  <p>
                    Quá khứ âm u của diva Mariah Carey được cô tiết lộ cụ thể
                    trong cuốn hồi kí “Ý nghĩa của Mariah Carey”.
                  </p>
                </div>
              </div>
              ...
              <div class="row my-2">
                ...
                <div class="col-md-7 col-sm-5 col-7">
                  ...
                  >
                    <span class="p-0"
                      >Tìm ra quán quân cuộc thi lồng tiếng đầu tiên..</span
                    >
                  </a>
                  <br />
                  <p class="genre p-1">Âm nhạc</p>
                  <p>
                    Sau 2 tháng diễn ra, Thanh âm kỳ diệu – cuộc thi tìm kiếm
                    tài năng lồng tiếng do Netflix và ...
                  </p>
                </div>
              </div>
            </div>
            ...
            <div class="col-md-4 col-sm-4 col-12 right mt-3 overlay">
              ...
              <a
                ...
                class="nav-link"
              >
                <span>Những sự thật thú vị về 'Doraemon: Stand by Me 2'</span>
              </a>
              <hr />
              <a
              ...
              >
                <span
                  >'Hải Tặc' trở lại: Kang Ha Neul - Han Hyo Joo siêu ngầu,
                  nhưng 'cái bóng' phần đầu quá lớn</span
                >
              </a>
              <hr />
              <a
              ...
              >
                <span
                  >Trúc Nhân, Lan Ngọc nhắng nhít trong hậu trường MV, hit Tết
                  2022 đây rồi?</span
                >
              </a>
              <hr />
              ...
              >
                <span
                  >Hướng dẫn cách combo kỹ năng Free Fire sau khi Chrono bị
                  Nerf</span
                >
              </a>
              <img
                class="col-md-12 col-sm-12 col-12 mt-3"
                style="border-radius: 7px"
                alt=""
                src="img/4-1615133669050997629964.png"
              />
        ...
        <section class="footer">
          <!-- Footer -->
          <footer
            class="text-black text-center text-md-start"
          ...
          >
              ...
              <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 col-12 mb-4 mb-md-0">
                  ...
                  <p style="font-size: 13px">
                    Đ/C:Hồ Tùng Mậu ,P.Mai Dịch,Q.Cầu Giấy ,Hà Nội <br />
                    Điện thoại:+84 947 0938 347 <br />
                    Email:Winchasersteam@gmail.com <br />
                  ...
                  >
                    ...
                    <li class="mb-2">
                      <a
                        ...
                        style="text-decoration: none"
                      >
                        Liên hệ gmail : windcharses@gmail.com</a
                      >
                    </li>
                  </ul>
                </div>
                  ...
                  <ul class="list-unstyled" style="margin-top: -20px">
                    <li class="mb-2">
                      <a href="#" class="text-black">
                        <i class="fab fa-facebook" style="font-size: 13px">
                    ...
                    <li class="mb-2">
                      <a href="#" class="text-black">
                        <i class="fab fa-google-plus" style="font-size: 13px">
            ...
            <div
              ...
              "
            >
              © Bản quyền thuộc về WindChasers | Cung cấp bởi figma
            </div>
            <!-- Copyright -->
          </footer>
          <!-- Footer -->
