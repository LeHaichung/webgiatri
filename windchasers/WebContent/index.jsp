					...
					<div class="collapse navbar-collapse" id="main-menu">
						<ul class="navbar-nav">
							...
							<li class="nav-item"><a class="nav-link px-4"
								style="color: black" href="Dienanh.jsp">Điện
									ảnh - Truyền hình</a></li>
							<li class="nav-item"><a class="nav-link px-4"
								style="color: black" href="amnhac.jsp">Âm nhạc</a></li>
							<li class="nav-item"><a class="nav-link px-4"
								style="color: black" href="game.jsp">Game</a></li>
							<li class="nav-item"><a class="nav-link px-4"
								style="color: black" href="truyen.jsp">Truyện
									tranh</a></li>
						</ul>
					</div>
				</nav>
				...
				<div class="row">
					<div class="col-md-8 col-sm-8 col-12 left">
						...
						<a class="row my-4"
							...
							class="rounded img-fluid col-md-4 col-sm-4 col-4" alt=""
							src="img/mariahcareyeternally12yearsold_2_thumb.jpg"> <img
							class="rounded img-fluid col-md-4 col-sm-4 col-4" alt=""
							src="img/mariah-carey-phot-lo-bfdc.jpg"> <img
							class="rounded img-fluid col-md-4 col-sm-4 col-4" alt="" src="img/mar2_bbfy.jpg">
						</a>
